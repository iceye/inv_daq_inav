...
{
  return (((float_t)(lsb * 1000)) / 4096.0f);
}
...
static uint32_t lps33w_temperature_cdegC;
...
static bool lps33wInit(baroDev_t * baro){
    ...
    /* Try to reset for DETECTION_MAX_RETRY_COUNT times */
    ...
    // Low pass filter mode at 1/9 ODR
