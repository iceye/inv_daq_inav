...
#define MSP2_INAV_INV_SENSOR_STATUS         0x3001 //  FLAGS FOR IAS, IAS AUX, IMU, MAG, GPS, ADC1, ADC2, ADC3
#define MSP2_INAV_INV_IF_STATUS             0x3011 //  FLAGS FOR RS232_1, RS232_2, RS232_3, RS232_4, RS485, CAN1, CAN2
#define MSP2_INAV_INV_IAS                   0x3050 //  IAS, IAS_AUX, TAS
#define MSP2_INAV_INV_IAS_STATUS            0x3051 //  IAS_STATUS, IAS_AUX_STATUS
#define MSP2_INAV_INV_IAS_EXTRA             0x3052 //  IAS_PRESSURE, IAS_AUX_PRESSURE, IAS_TEMPERATURE


#define MSP2_INAV_INV_AIRTEMP               0x3060 //  IAT, OAT

#define MSP2_INAV_INV_ALTITUDE              0x3070 //  ALTITUDE (QNH), DENSITY_ALT, STATIC_PRESSURE

#define MSP2_INAV_INV_ATTITUDE              0x3090 //  ROLL, PITCH, YAW, HEADING
#define MSP2_INAV_INV_ACC                   0x30B0 //  ACCEL_X, ACCEL_Y, ACCEL_Z
#define MSP2_INAV_INV_BALL                  0x30B5 //  BALL_POS_X

#define MSP2_INAV_INV_GPS_POS               0x30A0 //  TIMESTAMP, LATITUDE, LONGITUDE, ALTITUDE, COURSE
#define MSP2_INAV_INV_GPS_SPEED             0x30A2 //  3D_SPEED, GROUND_SPEED
#define MSP2_INAV_INV_GPS_ACC               0x30A3 //  HDOP, VDOP, PDOP
#define MSP2_INAV_INV_GPS_FIX               0x30A4 //  FIX_TYPE, NUM_SATS
#define MSP2_INAV_INV_GPS_NED               0x30A5 //  NORTH, EAST, DOWN SPEED

#define MSP2_INAV_INV_WIND                  0x30C0 //  WIND_SPEED, WIND_DIRECTION, WIND STATUS


#define MSP2_INAV_INV_CHT                   0x30D0 //  CHT1, CHT2, CHT3, CHT4
#define MSP2_INAV_INV_EGT                   0x30E0 //  EGT1, EGT2, EGT3, EGT4
#define MSP2_INAV_INV_LAMBDA                0x30F0 //  LAMBDA1
#define MSP2_INAV_INV_OIL                   0x3100 //  OIL_TEMP, OIL_PRESSURE
#define MSP2_INAV_INV_FUEL                  0x3110 //  FUEL_PRESSURE, FUEL_FLOW
#define MSP2_INAV_INV_FUELP_STATUS          0x3115 //  FUEL PUMP STATUS, FUEL PUMP VOLTAGE, FUEL PUMP CURRENT
#define MSP2_INAV_INV_TANK                  0x3120 //  TANK1, TANK2, TANK_AUX

#define MSP2_INAV_INV_RPM_MAP               0x3130 //  RPM ENGINE, PROP RPM/ROTOTR RPM, MAP
#define MSP2_INAV_INV_COUNTER_AUX           0x3135 //  AUX_COUNTER1, AUX_COUNTER2, AUX_COUNTER3, AUX_COUNTER4

#define MSP2_INAV_INV_COM_POSITIONS         0x3200 //  THROTTLE, RUDDER, AILERON, ELEVATOR
#define MSP2_INAV_INV_FLAP_TRIM             0x3220 //  FLAPS, TRIM_PITCH, TRIM_ROLL, TRIM_YAW


#define MSP2_INAV_INV_VOLTAGE               0x3300 //  MAIN_VOLTAGE (BATT), MAIN_CURRENT, GEN_CURRENT, GENERATOR ALARM FLAG

#define MSP2_INAV_INV_DAQ_STATUS            0x3400 //  VIN, VREF, VDDAN, GND, TEMP, MCU_TEMP, DAQ_STATUS

#define MSP2_INAV_INV_VHF_STATUS            0x3500 //  VHF_CONNECTION_STATUS, MAIN_FREQ, STBY_FREQ, DUAL_ACTIVE
#define MSP2_INAV_INV_VHF_SETTINGS          0x3550 //  VOL, SQ, VOX
#define MSP2_INAV_INV_VHF_SETTINGS_AUX      0x3555 //  AUX_VOL, INTERCOM_VOL, SIT_LEV, PIC_MIC_GAIN, COPILOT_MIC_GAIN, PTT_CONF, FREQ_SPACING_833KHZ (FLAG)
#define MSP2_INAV_INV_VHF_ERROR_STATUS      0x3590 //  VHF_DEVICE_ERROR, VHF_ERROR_CODE


#define MSP2_INAV_INV_XPDR_STATUS           0x3700 //  XPDR_CONNECTION_STATUS, XPDR_SQUAK_CODE, XPDR ALTITUDE IN FLIGHT LEVEL, XPDR_MODE (FLAG)



#define MSP2_INAV_INVSET_QNH                0x3071 //  QNH

#define MSP2_INAV_INVSET_TANK1_CAPACITY     0x3121 //  TANK1 TOTAL CAPACITY
#define MSP2_INAV_INVSET_TANK1_LEV_OHM     	0x3122 //  TANK1 OHM AT LITRES
#define MSP2_INAV_INVSET_TANK1_LEV_CURR     0x3123 //  TANK1 LITRES AT CURRENT READ

#define MSP2_INAV_INVSET_TANK2_CAPACITY     0x3124 //  TANK2 TOTAL CAPACITY
#define MSP2_INAV_INVSET_TANK2_LEV_OHM      0x3125 //  TANK2 OHM AT LITRES
#define MSP2_INAV_INVSET_TANK2_LEV_CURR     0x3126 //  TANK2 LITRES AT CURRENT READ

#define MSP2_INAV_INVSET_TANK_AUX_CAPACITY  0x3127 //  TANK_AUX TOTAL CAPACITY
#define MSP2_INAV_INVSET_TANK_AUX_LEV_OHM  	0x3128 //  TANK_AUX OHM AT LITRES
#define MSP2_INAV_INVSET_TANK_AUX_LEV_CURR  0x3129 //  TANK_AUX LITRES AT CURRENT READ

#define MSP2_INAV_INVSET_VHF_FREQ       	0x3520 //  MAIN/STDBY (FLAG), FREQ
#define MSP2_INAV_INVSET_DUAL		        0x3530 //  DUAL_ACTIVE (FLAG)
#define MSP2_INAV_INVSET_VHF_SETTINGS       0x3552 //  VOL, SQ, VOX
#define MSP2_INAV_INVSET_VHF_SETTINGS_AUX   0x3557 //  AUX_VOL, INTERCOM_VOL, SIT_LEV, PIC_MIC_GAIN, COPILOT_MIC_GAIN, PTT_CONF, FREQ_SPACING_833KHZ (FLAG)

#define MSP2_INAV_INVSET_XPDR_SQUAK         0x3712 //  XPDR_SQUAK_CODE
#define MSP2_INAV_INVSET_XPDR_IDENT         0x3720 //  ACTIVE(FLAG) - WHEN ACTIVE IT'S LIKE THE IDENT MOMENTARY BUTTON
#define MSP2_INAV_INVSET_XPDR_MODE          0x3742 //  XPDR_MODE (FLAG)
