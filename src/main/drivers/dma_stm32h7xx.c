...
static dmaChannelDescriptor_t dmaDescriptors[] = {
    ...
    //[3]  = DEFINE_DMA_CHANNEL(1, 6, 48), // DMA1_ST6
    [4]  = DEFINE_DMA_CHANNEL(1, 7, 54), // DMA1_ST7

    [5]  = DEFINE_DMA_CHANNEL(2, 0,  0), // DMA2_ST0
    [6]  = DEFINE_DMA_CHANNEL(2, 1,  6), // DMA2_ST1
    [7] = DEFINE_DMA_CHANNEL(2, 2, 16), // DMA2_ST2
    [8] = DEFINE_DMA_CHANNEL(2, 3, 22), // DMA2_ST3
    [9] = DEFINE_DMA_CHANNEL(2, 4, 32), // DMA2_ST4
    [10] = DEFINE_DMA_CHANNEL(2, 5, 38), // DMA2_ST5
    [11] = DEFINE_DMA_CHANNEL(2, 6, 48), // DMA2_ST6
    [12] = DEFINE_DMA_CHANNEL(2, 7, 54), // DMA2_ST7
};
