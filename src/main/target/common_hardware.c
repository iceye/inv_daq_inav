...
/** BAROMETERS **/
    ...
    #if defined(LPS33W_I2C_BUS) || defined(BARO_I2C_BUS)
        #if !defined(LPS33W_I2C_BUS)
            #define LPS33W_I2C_BUS BARO_I2C_BUS
        #endif
        #ifndef LPS33W_I2C_BUS_ADDR
            #define LPS33W_I2C_BUS_ADDR 0x5C /* WITH SD0/SA0 to GND */
        #endif
    BUSDEV_REGISTER_I2C(busdev_lps33w,      DEVHW_LPS33W,       LPS33W_I2C_BUS,     LPS33W_I2C_BUS_ADDR,  NONE,           DEVFLAGS_NONE, 0);
    #endif
#endif
...
#if defined(PITOT_I2C_BUS) && !defined(DLHR_I2C_BUS)
