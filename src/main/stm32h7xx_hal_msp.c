...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    */
    ...
    /* ADC1 DMA Init */
        /* ADC1 Init */
        invHdmaAdc1.Instance = DMA1_Stream4;
        invHdmaAdc1.Init.Request = DMA_REQUEST_ADC1;
        invHdmaAdc1.Init.Direction = DMA_PERIPH_TO_MEMORY;
        invHdmaAdc1.Init.PeriphInc = DMA_PINC_DISABLE;
        invHdmaAdc1.Init.MemInc = DMA_MINC_ENABLE;
        invHdmaAdc1.Init.PeriphDataAlignment = DMA_PDATAALIGN_WORD;
        invHdmaAdc1.Init.MemDataAlignment = DMA_MDATAALIGN_WORD;
        invHdmaAdc1.Init.Mode = DMA_CIRCULAR;
        invHdmaAdc1.Init.Priority = DMA_PRIORITY_LOW;
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    */
    ...
    HAL_GPIO_Init(GPIOF, &GPIO_InitStruct);
    	...
    	/* ADC2 DMA Init */
        /* ADC2 Init */
        invHdmaAdc2.Instance = DMA1_Stream5;
        invHdmaAdc2.Init.Request = DMA_REQUEST_ADC2;
        invHdmaAdc2.Init.Direction = DMA_PERIPH_TO_MEMORY;
        invHdmaAdc2.Init.PeriphInc = DMA_PINC_DISABLE;
        invHdmaAdc2.Init.MemInc = DMA_MINC_ENABLE;
        invHdmaAdc2.Init.PeriphDataAlignment = DMA_PDATAALIGN_WORD;
        invHdmaAdc2.Init.MemDataAlignment = DMA_MDATAALIGN_WORD;
        invHdmaAdc2.Init.Mode = DMA_CIRCULAR;
        invHdmaAdc2.Init.Priority = DMA_PRIORITY_LOW;
  ...
  /* USER CODE BEGIN ADC3_MspInit 1 */
    	...
    	/* ADC2 DMA Init */
        /* ADC2 Init */
    	invHdmaAdc3.Instance = DMA1_Stream6;
        invHdmaAdc3.Init.Request = DMA_REQUEST_ADC3;
        invHdmaAdc3.Init.Direction = DMA_PERIPH_TO_MEMORY;
        invHdmaAdc3.Init.PeriphInc = DMA_PINC_DISABLE;
        invHdmaAdc3.Init.MemInc = DMA_MINC_ENABLE;
        invHdmaAdc3.Init.PeriphDataAlignment = DMA_PDATAALIGN_WORD;
        invHdmaAdc3.Init.MemDataAlignment = DMA_MDATAALIGN_WORD;
        invHdmaAdc3.Init.Mode = DMA_CIRCULAR;
        invHdmaAdc3.Init.Priority = DMA_PRIORITY_LOW;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PF12     ------> ADC1_INP6
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_3|GPIO_PIN_6);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_2|GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_7);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PH5     ------> ADC3_INP16
    */
    HAL_GPIO_DeInit(GPIOF, GPIO_PIN_3|GPIO_PIN_8|GPIO_PIN_9|GPIO_PIN_10);
...
void HAL_TIM_IC_MspInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    PE9     ------> TIM1_CH1
    */
    GPIO_InitStruct.Pin = AUXCOUNTER_1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
    HAL_GPIO_Init(AUXCOUNTER_1_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM17_MspInit 0 */
    ...
    PF7     ------> TIM17_CH1
    */
    GPIO_InitStruct.Pin = FUEL_FLOW_A_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM17;
    HAL_GPIO_Init(FUEL_FLOW_A_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM5_MspPostInit 0 */
    ...
    PH10     ------> TIM5_CH1
    */
    GPIO_InitStruct.Pin = AUXCOUNTER_4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM5;
    HAL_GPIO_Init(AUXCOUNTER_4_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PE9     ------> TIM1_CH1
    */
    HAL_GPIO_DeInit(AUXCOUNTER_1_GPIO_Port, AUXCOUNTER_1_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PI7     ------> TIM8_CH3
    */
    HAL_GPIO_DeInit(AUXCOUNTER_3_GPIO_Port, AUXCOUNTER_3_Pin);
  ...
  /* USER CODE END TIM12_MspDeInit 0 */
    ...
    PH9     ------> TIM12_CH2
    */
    HAL_GPIO_DeInit(RPM_CH_A_GPIO_Port, RPM_CH_A_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM17_MspDeInit 0 */
    ...
    PF7     ------> TIM17_CH1
    */
    HAL_GPIO_DeInit(FUEL_FLOW_A_GPIO_Port, FUEL_FLOW_A_Pin);
